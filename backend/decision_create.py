...
def get_underlined(reason):
    ...
    list_of_underlined.append(reason == "niespełnosprawność ruchową, w tym z afazją")
    list_of_underlined.append(reason == "niepełnosprwaność intelektualną w stopniu lekkim")
    list_of_underlined.append(reason == "niepełnosprwaność intelektualną w stopniu umiarkowanym")
    list_of_underlined.append(reason == "niepełnosprwaność intelektualną w stopniu znacznym")
