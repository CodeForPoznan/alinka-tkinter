...
from .fixtures import staff, staffmeeting, places
...
class DataBase():
    def __init__(self, dbase):
        ...
        self.cur.execute('''CREATE TABLE IF NOT EXISTS staffmeeting (
            id INTEGER PRIMARY KEY,
            date TEXT,
            member1 INTEGER,
            member2 INTEGER,
        ...
        self.cur.execute('''CREATE TABLE IF NOT EXISTS school (
            id INTEGER PRIMARY KEY,
            name TEXT,
            sort TEXT,
            address TEXT,
    ...
    def add_fake_data(self):
        ...
        for i in places:
            self.cur.execute('''INSERT INTO school VALUES(NULL, ?, ?, ?, ?)''', i)
    ...
    def get_student_data(self, pesel="", id=""):
        ...
        student = dict(
            zip(
                [
                    'id', 'name_n', 'name_g', 'zip_code', 'city', 'address',
                    'pesel', 'birth_date', 'birth_place', 'casebook', 'school_name',
    ...
    def convert_to_staff(self, id):
        ...
        who_meets = [x for x in staff_data[2:-1] if x != None]
    ...
    def get_staffmeeting_data(self, staffmeeting_id):
        ...
        staff = [
            staffmeeting_data['member{}'.format(x)] for x in range(1,10) if staffmeeting_data['member{}'.format(x)] !=None
            ]

        for i in staff:
            staffmeeting_data['team'].append(
            self.who_is(i)
            )
