...
class MainWindow():
    def __init__(self, window):
        ...
        self.actual_student.grid(row=0, column=1, sticky='wn', padx=5)
        self.applicationframe = Application(self.window, text="Wnioskodawcy")
        self.applicationframe.grid(row=1, column=1, sticky='w', padx=5)
        ...
        self.staff_meeting_frame.grid(row=0, column=2, rowspan=2, sticky='w', padx=5)
