...
from tkinter.ttk import Button, Label, Labelframe, Combobox, Separator
import re
...
class StudentData(Labelframe):
    ...
    def __init__(self, window, base, **kwargs):
        ...
        self.name_of_student_n_lab = Label(self, text="Imię i nazwisko dziecka (mianownik)")
        self.name_of_student_n_lab.grid(row=0, column=0, columnspan=2, sticky='w', padx=5, pady=5)
        self.name_of_student_n_entry = Entry(self, width=40)
        self.name_of_student_n_entry.grid(row=0, column=2, columnspan=3)

        self.name_of_student_g_lab = Label(self, text="Imię i nazwisko dziecka (dopełniacz)")
        self.name_of_student_g_lab.grid(row=1, column=0, columnspan=2, sticky='w', padx=5, pady=5)
        self.name_of_student_g_entry = Entry(self, width=40)
        self.name_of_student_g_entry.grid(row=1,column=2, columnspan=3)

        self.pesel_lab = Label(self, text="PESEL")
        self.pesel_lab.grid(row=2,column=0, sticky='w', padx=5, pady=5)
        self.pesel_entry = Entry(self, textvariable=self.pesel_string, width=12)
        self.pesel_entry.grid(row=2, column=1, sticky='w')

        self.city_of_student_lab = Label(self, text="Miejscowość")
        self.city_of_student_lab.grid(row=3, column=0, sticky='w', padx=5, pady=5)
        self.city_of_student_entry = Entry(self, width=21)
        self.city_of_student_entry.grid(row=3, column=1, sticky='w')
        
        self.birth_place_lab = Label(self, text="Miejsce urodzenia")
        self.birth_place_lab.grid(row=2, column=3, sticky='e')
        self.birth_place_entry = Entry(self, width=25)
        self.birth_place_entry.grid(row=2, column=4)

        self.id_of_student = Label(self, text="Teczka")
        self.id_of_student.grid(row=2, column=5, padx=5, pady=5, sticky='e')
        self.id_of_student_entry = Entry(self, width=7)
        self.id_of_student_entry.grid(row=2, column=6, padx=5, pady=5)

        self.zip_code_of_student_lab = Label(self, text="Kod")
        self.zip_code_of_student_lab.grid(row=3, column=5, padx=5, pady=5, sticky='e')
        self.zip_code_of_student_entry = Entry(self, width=7)
        self.zip_code_of_student_entry.grid(row=3, column=6, padx=5, pady=5)

        self.address_of_student_lab = Label(self, text="Adres dziecka")
        self.address_of_student_lab.grid(row=3, column=3, sticky='e')
        self.address_of_student_entry = Entry(self, width=25)
        self.address_of_student_entry.grid(row=3, column=4)

        self.sort_of_school_lab = Label(self, text="Rodzaj szkoły")
        self.sort_of_school_lab.grid(row=6, column=0, sticky='w', padx=5, pady=5)
        ...
        self.school_lab.grid(row=7, column=0, sticky='w', padx=5, pady=5)
        self.school = Combobox(self, width=60, postcommand=self.list_of_schools, exportselection=False)
        ...
        self.profession_lab.grid(row=6, column=3, sticky='e')
        self.profession_entry = Entry(self, width=25)
        self.profession_entry.grid(row=6, column=4)
        
        self.class_lab = Label(self, text="Klasa")
        self.class_lab.grid(row=6, column=5, padx=5, pady=5, sticky='e')
        self.class_entry = Entry(self, width=7)
        self.class_entry.grid(row=6, column=6)
